				...
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php">
							...
							</span> NexGest<span class="dashboard_text">sistema de gestão</span></a></h1>
					</div>
			...
			<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<input type="text" class="form-control" id="endereco_perfil" name="endereco" placeholder="Seu Endereco" value="<?php echo $endereco_usuario ?>">
						</div>
					</div>
